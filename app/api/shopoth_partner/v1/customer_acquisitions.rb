module ShopothPartner
  module V1
    class CustomerAcquisitions < ShopothPartner::Base
      resource :customer_acquisitions do
        ...
        post do
          # acquisition_data = CustomerAcquisition.add_acquisition(declared(params, include_missing: false), @current_partner, @locale)
         # success_response_with_json(I18n.t('common.success.messages.customer_acquire'), HTTP_CODE[:CREATED], acquisition_data)
          success_response_with_json('Customer acquisition is currently off', HTTP_CODE[:NO_CONTENT])
        ...
        route_param :id do
          ...
          put :otp_verify do
            ...
            CustomerAcquisition.verify_otp(params[:otp], user, @current_partner, @locale)
        ...
        route_param :id do
          get :greetings do
            ...
            user.customer_acquisition.send_greetings(@current_partner, @locale)
        ...
        get :monthly_reports do
          success_response_with_json(I18n.t('common.success.messages.customer_acquire_reports'), HTTP_CODE[:OK],
                                     @current_partner&.customer_acquisition_reports(params))
        rescue StandardError => error
        ...
        route_param :id do
          ...
          put do
            ...
            user.customer_acquisition.update_additional_info(declared(params, include_missing: false), @current_partner, @locale)
