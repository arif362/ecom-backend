module PaymentManagement
  module Nagad
    class InitiatePayment
      ...
      delegate :invoice, :ip_address, to: :context

      def call
        Rails.logger.info "Sending Nagad intiaite request...."
        url = URI("#{ENV['NAGAD_API_URL']}/api/dfs/check-out/initialize/#{merchant_id}/#{invoice_id}")
        ...
        Rails.logger.info "Nagad Checkout Initialize Response for #{invoice.id}: #{response_body}"
